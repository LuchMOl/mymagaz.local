...
INSERT INTO `product_category` VALUES (1,61),(1,64),(1,68),(1,92),(2,3316),(2,57),(3,3315),(3,3316),(3,25),(4,3071),(4,3081),(5,3071),(5,3081);
...
CREATE TABLE `products` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Товары';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `products` VALUES (1,'Труселя \"От винта\"'),(2,'Труселя свинцовые'),(3,'Купальник \"Полосатик\"'),(4,'Шапка-ушанка'),(5,'Носки шестипалые');
...
-- Dump completed on 2020-07-07 22:42:26

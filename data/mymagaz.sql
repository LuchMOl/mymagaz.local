...
INSERT INTO `cart` VALUES (6,1,NULL,5,4,2,3);
...
INSERT INTO `currency` VALUES (1,'UAH','₴',1.0000,1.0000,1,1),(2,'USD','$',28.0500,28.5000,0,1),(3,'EUR','€',32.8500,33.4500,0,1);
...
INSERT INTO `products` VALUES (1,'Труселя ',300,1),(2,'Труселя свинцовые',250,1),(3,'Купальник ',23,2),(4,'Шапка-ушанка',18,3),(5,'Носки шестипалые',2,3),(6,'1000',1000,1),(7,'500',500,1),(8,'Forani',321,1),(9,'Рюкзак',1100,1),(10,'Сумка ',123,2),(11,'Голубенький костюмчик',31,3),(12,'123',1234,1);
...
INSERT INTO `session_user` VALUES (1,'71lfheb3p8irq4054jj9h713n5'),(2,'4cq9n88l4k12k0i71jd4209fn6'),(3,'bh46skss8dhprksj65hcgomsj2'),(4,'d2mpj39tsiqg1e30c7460d6b47'),(5,'1qln0nqe7qndvejtcr7at0bvi0'),(6,'a2u3lh790pj4sh5rc0fmfrnnr2');
...
INSERT INTO `users` VALUES (1,'admin@mymagaz.local','admin','admin',3),(2,'user@mymagaz.local','user','user',1),(3,'test@mymagaz.local','test','test',1),(4,'123@mymagaz.local','123','123',1),(5,'456@mymagaz.local','456','456',1),(6,'345345@mymagaz.local','345345','345345',1);
...
-- Dump completed on 2020-10-15 19:29:02
